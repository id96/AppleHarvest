...
<html lang="en">
	...
	<body>
		...
		<div class="content">
			...
			<div class="section">
				<img class="section_image" src="images/IV-AppleFest006(Photo%20by%20Alisha%20Tamarchenko%EF%BC%89.jpg" alt="apple" />
				<div class="section_content right">
					...
					<!-- credit: http://www.ithacaorganicapples.com/varieties.cfm -->
				</div>
			</div>
